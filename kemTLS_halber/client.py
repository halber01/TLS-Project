...
from kemTLS_halber.kyberpy.src.kyber_py.kyber import Kyber512
from kemTLS_halber.config import HOST, PORT
from kemTLS_halber.helper.clientHelper import *
from kemTLS_halber.helper.socketHelper import recv_msg, send_msg
import socket
import os
...
def perform_handshake():
    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        if app_data != bytes("Server Finished", 'utf-8'):
